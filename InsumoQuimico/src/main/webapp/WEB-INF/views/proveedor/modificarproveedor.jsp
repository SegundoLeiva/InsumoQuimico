							...
							<div class="control-group">
								...
								<div class="controls">
									<form:input type="text" path="rucProv" id="rucProv"
										...
										pattern=".{11,11}" title="solo puedes escribir 11 dígitos"
										class="numeros" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<form:input type="text" path="desProv" id="desProv"
										placeholder="Descripción" value="${model.datosproveedor[1]}" />
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<form:input type="text" path="dirProv" id="dirProv"
										placeholder="Dirección" value="${model.datosproveedor[3]}" />
