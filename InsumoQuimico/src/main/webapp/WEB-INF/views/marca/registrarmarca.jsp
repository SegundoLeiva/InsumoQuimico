...
<div class="page-header">
	<h1>
		Registrar Marca <small> <i class="icon-double-angle-right"></i>
...
<div class="page-header position-relative">
	<form id="form_marca" class="form-horizontal">
		<div class="row-fluid">
		...
		<div style="display: none" id="mensajealerta"
			...
			</strong> Su marca se registró exitosamente. <br>
		</div>
		...
		<div class="form-actions">
			...
			<button title="Agregar Marca" type="submit" class="btn btn-success">
	...
	$('#form_marca')
			.submit(
					function(event) {
						...
						$
								.post(
										'${pageContext.request.contextPath}/sistema/registrarmarca.htm',
										asd,
										function(response) {
											if (response == "error") {
												document
