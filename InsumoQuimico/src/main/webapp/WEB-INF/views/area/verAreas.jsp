					...
					<tbody>
						<c:forEach var="jbean" items="${listaConsulta}"
							...
							<tr>
								...
								<td class="center"><a
									href="modificar.htm?id=<c:out value="${jbean.idArea}" />"
									title="Modificar Área"><c:out value="${jbean.idArea}"></c:out></a></td>
								<td class="center"><c:out value="${jbean.area}"></c:out></td>
								...
								<td class="center"><a class="red" href="#" onclick="eliminarSearch('${jbean.idArea}')"> <i
